        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <ul class="nav nav-pills card-header-pills">
                    <li class="nav-item">
                        <a class="nav-link @if( request()->segment(1) == 'products' && request()->segment(2) == '' ) active @endif" href="{{ route( 'products.index' ) }}">Published</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @if( request()->segment(2) == 'trash' ) active @endif" href="{{ route( 'products.trash' ) }}">Trash</a>
                    </li>
                </ul>
            </div>
        </div>
